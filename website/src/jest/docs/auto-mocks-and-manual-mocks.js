...
module.exports = React.createClass({
  render: function() {
    return layout({metadata: {"filename":"AutoMocksAndManualMocks.js","id":"auto-mocks-and-manual-mocks","title":"Auto Mocks and Manual Mocks","layout":"docs","category":"Guides","permalink":"auto-mocks-and-manual-mocks.html","previous":"mock-functions","next":"asynchronous-testing","href":"/jest/docs/auto-mocks-and-manual-mocks.html"}}, `---
...
The \`jest\` built-in module provides convenient features for building mock module implementations. The main features of the library are mock functions and special handling to make it easier to work with function prototypes.
