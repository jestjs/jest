...
module.exports = React.createClass({
  render: function() {
    return layout({metadata: {"id":"tutorial-coffeescript","title":"Tutorial - CoffeeScript","layout":"docs","category":"Quick Start","permalink":"docs/tutorial-coffeescript.html","next":"tutorial-react"}}, `
