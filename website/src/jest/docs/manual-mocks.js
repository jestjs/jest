...
module.exports = React.createClass({
  render: function() {
    return layout({metadata: {"filename":"ManualMocks.js","id":"manual-mocks","title":"Manual mocks","layout":"docs","category":"Reference","permalink":"manual-mocks.html","previous":"mock-functions","next":"timer-mocks","href":"/jest/docs/manual-mocks.html"}}, `
