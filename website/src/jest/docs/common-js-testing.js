...
module.exports = React.createClass({
  render: function() {
    return layout({metadata: {"id":"common-js-testing","title":"CommonJS Testing","layout":"docs","category":"Core Concepts","permalink":"docs/common-js-testing.html","next":"automatic-mocking"}}, `
