...
module.exports = React.createClass({
  render: function() {
    return layout({metadata: {"id":"automatic-mocking","title":"Automatic Mocking","layout":"docs","category":"Core Concepts","permalink":"docs/automatic-mocking.html","next":"mock-functions"}}, `
