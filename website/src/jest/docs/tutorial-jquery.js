...
module.exports = React.createClass({
  render: function() {
    return layout({metadata: {"id":"tutorial-jquery","title":"Tutorial - jQuery","layout":"docs","category":"Quick Start","permalink":"docs/tutorial-jquery.html","next":"tutorial-coffeescript"}}, `
