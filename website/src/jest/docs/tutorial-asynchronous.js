...
module.exports = React.createClass({
  render: function() {
    return layout({metadata: {"id":"tutorial-asynchronous","title":"Tutorial - Asynchronous","layout":"docs","category":"Quick Start","permalink":"docs/tutorial-asynchronous.html","next":"tutorial-jquery"}}, `
