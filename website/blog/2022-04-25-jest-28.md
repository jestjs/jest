...
The guide should hopefully make migration trivial, but note that if you use any of the packages Jets consists of directly, instead of just running `jest`, then you need to go through the changelog to view any breaking changes.
...
This has been one of the biggest compatibility issues of Jest, and hopefully this is now resolved onoce and for all.
