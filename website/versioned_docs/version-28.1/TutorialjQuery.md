...
To get started with the JSDOM [test environment](https://jestjs.io/docs/next/configuration#testenvironment-string), the `jest-environment-jsdom` package must be installed:
