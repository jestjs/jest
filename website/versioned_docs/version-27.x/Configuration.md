...
This option allows the use of a custom global setup module which exports an async function that is triggered once before all test suites. This function gets Jest's [`globalConfig`](https://github.com/jestjs/jest/blob/v27.5.1/packages/jest-types/src/Config.ts#L288-L350) object as a parameter.
...
This option allows the use of a custom global teardown module which exports an async function that is triggered once after all test suites. This function gets Jest's [`globalConfig`](https://github.com/jestjs/jest/blob/v27.5.1/packages/jest-types/src/Config.ts#L288-L350) object as a parameter.
...
Custom reporter modules must define a class that takes a [`globalConfig`](https://github.com/jestjs/jest/blob/v27.5.1/packages/jest-types/src/Config.ts#L288-L350) and reporter options as constructor arguments:
...
To write a test-runner, export a class with which accepts [`globalConfig`](https://github.com/jestjs/jest/blob/v27.5.1/packages/jest-types/src/Config.ts#L288-L350) in the constructor, and has a `runTests` method with the signature:
