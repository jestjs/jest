...
console.log(pc.inverse(' Building TypeScript definition files '));

try {
  await execa('yarn', args, {stdio: 'inherit'});
  console.log(
    pc.inverse(pc.green(' Successfully built TypeScript definition files ')),
  );
} catch (error) {
  console.error(
    pc.inverse(pc.red(' Unable to build TypeScript definition files ')),
  );
  throw error;
}

console.log(pc.inverse(' Validating TypeScript definition files '));
...
try {
  ...
  console.error(
    pc.inverse(pc.red(' Unable to validate TypeScript definition files ')),
  );
...
console.log(
  pc.inverse(pc.green(' Successfully validated TypeScript definition files ')),
);
