...
One of the most powerful features of jest is it's built-in mocking capabilities. By default, when a test (or any file) runs inside jest, `require()` always returns the an automatically generated mock version of the module that was requested rather than the real version. This is really powerful because it makes easy to write tests that exercise only the code you wish to exercise -- nothing more, nothing less. Of course, you can (and probably should) customize this default behavior for your specific test.

Let's look at an example.

TODO: Write out a simple but reasonable example
