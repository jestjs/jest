...
const diffsCommonStartEnd = [
  ...
  new Diff(DIFF_INSERT, ['change ', changeColor('receive'), 'ed A'].join('')),
  ...
  new Diff(DIFF_INSERT, ['change ', changeColor('receive'), 'ed B'].join('')),
  ...
  new Diff(DIFF_INSERT, ['change ', changeColor('receive'), 'ed C'].join('')),
