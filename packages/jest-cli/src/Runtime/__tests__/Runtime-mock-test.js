...
describe('Runtime', () => {
  ...
  describe('jest.mock', () => {
    ...
    it('sets virtual mock for non-exciting module', () =>
      createRuntime(__filename).then(runtime => {
        ...
        root.jest.mock('NotInstalledModule', () => mockReference, {virtual: true});
        root.jest.mock('../ManuallyMocked', () => mockReference, {virtual: true});
