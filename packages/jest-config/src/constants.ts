...
export const JEST_CONFIG_EXT_YAML = '.yaml';
export const JEST_CONFIG_EXT_YML = '.yml';
export const JEST_CONFIG_EXT_ORDER = Object.freeze([
  ...
  JEST_CONFIG_EXT_YAML,
  JEST_CONFIG_EXT_YML,
]);

const JEST_CONFIG_RC_EXT_ORDER = Object.freeze([
  '',
  JEST_CONFIG_EXT_JSON,
  JEST_CONFIG_EXT_YAML,
  JEST_CONFIG_EXT_YML,
...
export const JEST_CONFIG_SEARCH_PLACES = Object.freeze([
  ...JEST_CONFIG_EXT_ORDER.map(ext => `${JEST_CONFIG_BASE_NAME}${ext}`),
  ...JEST_CONFIG_RC_EXT_ORDER.map(ext => `.jestrc${ext}`),
  ...JEST_CONFIG_RC_EXT_ORDER.map(ext => `.config/jestrc${ext}`),
  PACKAGE_JSON,
]);
