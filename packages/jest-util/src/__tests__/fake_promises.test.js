...
describe('FakePromises', () => {
  ...
  describe('runAllPromises', () => {
    ...
    describe('_Promise.resolve()', () => {
      ...
      describe('if resolved value is a promise', () => {
        it('returns the resolved promise instead of creating a new promise', () => {
          const global = {};
          const runAllTicks = () => {};
          const promises = new FakePromises({
            global,
        ...
        it("reschedules the callback to the end of the promise's children queue", () => {
          const global = {};
          const runAllTicks = () => {};
          const promises = new FakePromises({
            global,
      ...
      describe('if resolved value is a thenable', () => {
        ...
        it('adds one more promise to the promise chain than a normal resolved value', () => {
          ...
          Promise.resolve(thenable).then(mock1);
          Promise.resolve(0).then(mock2);
    ...
    describe('_Promise.then()', () => {
      ...
      it('passes errors thrown in the onResolved callback as a reason to the next onRejected callback', () => {
        ...
        const mock1 = jest.fn(() => Promise.reject('mock1'));
        const mock2 = jest.fn(() => 'mock2');
      ...
      describe('if onRejected callback is provided', () => {
        it("doesn't catch errors that occur in the onFulfilled callback", () => {
          const runAllTicks = () => {};
          const promises = new FakePromises({
            config: {
              rootDir: __dirname,
    ...
    describe('_Promise.race()', () => {
      ...
      it('returns first promise to resolve', () => {
        ...
        const p1 = Promise.resolve(0).then(() => 'x');
        const p2 = Promise.resolve('y');
        const mock1 = jest.fn(() => {});
