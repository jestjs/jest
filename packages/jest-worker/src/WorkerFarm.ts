...
type ResolvedWorkerFarmOptions = WorkerFarmOptions & {
...
export default class WorkerFarm {
  ...
  private _farm: Farm;
  private _options: ResolvedWorkerFarmOptions;
  private _workerPool: WorkerPoolInterface;

  constructor(workerPath: string, options: ResolvedWorkerFarmOptions) {
    ...
    this._options.exposedMethods.forEach(methodName => {
      // @ts-expect-error: dynamic extension of the class instance is expected.
      this[methodName] = this._callFunctionWithArgs.bind(this, methodName);
    });
  }
