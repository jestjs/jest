...
- `[jest-core, jest-reporters]` [**BREAKING**] Make the completed `coverageMap` available before calling reporters' `onRunComplete`, without changing reporter output order ([#16431](https://github.com/jestjs/jest/pull/16431))
