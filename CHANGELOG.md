...
- `[jest-core, jest-reporters]` [**BREAKING**] Make the completed `coverageMap` available before calling reporters' `onRunComplete`, without changing reporter output order
