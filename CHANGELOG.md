...
- `[jest-reporters]` [**BREAKING**] Remove type reexport, they must be imported from `@jest/test-result` and `@jest/types` ([#12657](https://github.com/facebook/jest/pull/12657))
