...
- `[jest-jasmine2]` Will now only execute at most 5 concurrent tests *within the same testsuite* when using `test.concurrent` ([#7770](https://github.com/facebook/jest/pull/7770))
