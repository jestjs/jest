...
- `[jest-docblock]` Add `extractAll()`, which returns every docblock that precedes the first statement of a file instead of only the first one ([#16424](https://github.com/jestjs/jest/pull/16424))
