...
### Features
- `[jest-config]` [**BREAKING**] Rename `moduleLoader` to `runtime` and `extraGlobals` to `sandboxInjectedGlobals` configuration options ([#10817](https://github.com/facebook/jest/pull/10817))
