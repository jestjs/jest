...
- `[jest-config, jest-haste-map]` Add `haste.watcher` config option (`'default' | 'parcel'`) to select the file-crawl/watch backend ([#16184](https://github.com/jestjs/jest/pull/16184))
