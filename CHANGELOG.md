...
- `[jest-resolve]` Wrapped realpath usage with try-catch block to avoid failures on network drives and ram disks ([#8291](https://github.com/facebook/jest/pull/8292))
