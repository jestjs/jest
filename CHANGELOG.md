...
- `[jest-haste-map]` Shut the worker farm down when a duplicate manual mock aborts the build under `throwOnModuleCollision` ([#16349](https://github.com/jestjs/jest/pull/16349))
