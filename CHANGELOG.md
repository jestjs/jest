...
- `[jest-core, jest-changed-files]` Resolve the VCS roots once per set of roots and reuse them across `--onlyChanged` runs, instead of shelling out to `git`, `hg` and `sl` on every run ([#16434](https://github.com/jestjs/jest/pull/16434))
