...
- `[jest-editor-support]` and `[jest-test-typescript-parser]`: add support for describe blocks, template literals and string buffer parsing ([#7215](https://github.com/facebook/jest/pull/7215))
