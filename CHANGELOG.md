...
- `[pretty-format]` Rename npm alias keys `react-is-18`/`react-is-19` to `react-is-v18`/`react-is-v19` to avoid collision with identically-named packages published to the npm registry ([#16281](https://github.com/jestjs/jest/pull/16281))
