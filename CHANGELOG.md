...
- `[jest-reporters]` Add `collectCoverageFromTestedOnly` option to allow ignoring all untested files from coverage ([#14207](https://github.com/facebook/jest/pull/14207))
