...
- `[jest-circus, jest-environment, jest-runtime, jest-snapshot]` Add describe-level retries via `jest.retryTimes(..., {entireDescribe: true})` ([#16322](https://github.com/jestjs/jest/pull/16322))
