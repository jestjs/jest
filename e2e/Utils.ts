...
export const linkJestPackage = (packageName: string, cwd: Config.Path): void  => {
 ...
 */
export const generateTestFilesToForceUsingWorkers = (): Record  => {
...
export const replaceTime = (str: string):string =>
  str
...
export const sortLines = (output: string):string =>
  output
    .split('\n')
    .sort()
    .map(str => str.trim())
...
export const testIfHg = (...args: Parameters<typeof test>):void => {
