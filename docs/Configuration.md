...
If you need to restrict your test-runner to only be run in serial rather than in parallel, your class should have the property `isSerial` to be set as `true`.
