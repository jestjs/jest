...
Examples of such compilers include [jstransform](http://github.com/facebook/jstransform), [recast](http://github.com/benjamn/recast), [regenerator](http://github.com/facebook/regenerator), [async-to-gen](http://github.com/leebyron/async-to-gen#jest), and [traceur](https://github.com/google/traceur-compiler).
