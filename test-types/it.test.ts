...
expectType<void>(it('name', callback => {
...
expectType<void>(it.only('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(it.skip('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(it.todo('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(it.concurrent('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(fit('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(fit.only('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(fit.skip('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(fit.todo('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(fit.concurrent('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xit('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xit.only('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xit.skip('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xit.todo('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xit.concurrent('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(test('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(test.only('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(test.skip('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(test.todo('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(test.concurrent('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xtest('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xtest.only('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xtest.skip('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xtest.todo('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
...
expectType<void>(xtest.concurrent('name', callback => {
  expectType<jest.DoneCallback>(callback);
}, 9001));
